...
In the first exercise, we will be studying Nb~2~C MXene about how to relax it into a optimized structure, and how to adsorb atoms on the high symmetry sites, followed by Density of States(DOS) calculation of the relaxed sturcture. For Homework 5, everyone will be adsorbing the same atom, Cl. 
